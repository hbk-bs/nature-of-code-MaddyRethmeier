...
const config = {
    ...
    angleOffsetBase: 75,   // Base central angle
    angleOffsetVariation: 10, // Variation around the base
    arcApertureBase: 140,  // Base angular width
    arcApertureVariation: 20, // Variation around the base
    numLayers: 500,
    ...
    oysterColorsStart: [200, 20, 70], // HSB
    oysterColorsMid: [210, 30, 60],
    oysterColorsEnd: [220, 10, 80],
    layersPerFrameMin: 5,
    layersPerFrameMax: 15,
    numLobesOnEdgeBase: 5, // Base number of lobes
    numLobesOnEdgeVariation: 2, // Variation around the base
    noiseMagnitudeFactorBase: 0.1, // Base noise magnitude
    noiseMagnitudeFactorVariation: 0.03, // Variation around the base
    noiseSmoothnessBase: 0.05, // Base noise smoothness
    noiseSmoothnessVariation: 0.02, // Variation around the base
    angleStep: 1,
    pauseDurationFrames: 100,
    strokeWeightMin: 1,
    strokeWeightMax: 2.5,
    alpha: 0.9
};
...
function windowResized() {
    ...
    umboX = width / 3;
    umboY = height / 3;
    resetShell(); // Redraw with new parameters on resize (optional)
}

// Optional: Add mouse interaction to force a reset
// function mousePressed() {
//     resetShell();
// }
// Optional: Add mouse interaction to pause/resume or reset
// function mousePressed() {
//     resetShell();
// }// function keyPressed() {
//   if (key === 's' || key === 'S') {
//     saveCanvas('oyster_shell', 'png');
//     console.log('Shell saved!');
//   }
// }